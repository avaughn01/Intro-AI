...
public class ModelLoadFirstAdjust {
    private static Logger log = LoggerFactory.getLogger((ModelLoadFirstAdjust.class));

    public static void main(String[] args) throws IOException {
        int height = 51;        //img height
        int width = 51;         //img width
        int channels = 1;       //greyscale
        int rngseed =123;
        Random randNumGen = new Random(rngseed);
        int batchSize = 100;
        String modelLocation = "modelFirstAdjust.zip";
